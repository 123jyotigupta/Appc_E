...
module.exports = {
	...
	admin: {
		...
		validEmails: ["jgupta@itexico.net"],
	...
	session: {
		...
		encryptionKey: '8N3GsG0tlvpJfL03P4yneDnXsqV44QkH+4ad/OnzBY0=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'w379JDOKnIVJsstBIBu64+gK5dm+GCYb8nX9mlrAjbZLGEQG3S+bcMQIjhPHFPJU9CG/gIkoGiYMMIBRpBJ7YQ==',
		secret: 'YffusjFEOtzhDRrFAIdYG3dfk8sxaJ1I', // should be a large unguessable string
